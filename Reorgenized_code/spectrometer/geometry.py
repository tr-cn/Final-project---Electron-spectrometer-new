...
class Spectrometer_Budy():
    def __init__(self, height_mm =26, width_mm = 12.5, depth_mm   = 50.8, pinhole_dia_mm =3, shield_mm = 0, yoke=1, shiled=0):
    ...
    def  _draw_spec (self):
        height_mm = self.height_mm; width_mm = self.width_mm; depth_mm = self.depth_mm;
        pinhole_dia_mm = self.pinhole_dia_mm; shield_mm = self.shield_mm;
...
#     spec = Spectrometer_Budy(height_mm, width_mm, depth_mm, pinhole_dia_mm, yoke, shiled)
#     ax, fig = spec._draw_spec()
