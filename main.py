...
if __name__ == "__main__":
    ...
    print(Z_mm)
    R_vec_mm,v_vec_m0s,gamma_vec = integ.euler (e_eng_MeV, me_kg, e_C, height_mm, width_mm, depth_mm, B_T, E_V0m, R0_mm, steps )
    pr.trajectory_plot(ax, R_vec_mm)
    print(R_vec_mm[-1])
    
    R_vec_mm,v_vec_m0s,gamma_vec = integ.RK2 (e_eng_MeV, me_kg, e_C, height_mm, width_mm, depth_mm, B_T, E_V0m, R0_mm, steps )
    pr.trajectory_plot(ax, R_vec_mm)
    print(R_vec_mm[-1])
    
    R_vec_mm,v_vec_m0s,gamma_vec = integ.RK4 (e_eng_MeV, me_kg, e_C, height_mm, width_mm, depth_mm, B_T, E_V0m, R0_mm, steps )
    pr.trajectory_plot(ax, R_vec_mm)
    print(R_vec_mm[-1])
